...
class NeuralNetwork(object):
    ...
    def backprop(self, X, y):
        ...
        dW2 = 1/num_examples * np.dot(self.a1.T, delta3)
        db2 = 1/num_examples * np.sum(delta3, axis = 0, keepdims = True)
        delta2 = np.multiply(delta3.dot(self.W2.T),
                             self.diff_actFun(self.a1, self.actFun_type))
        dW1 = 1/num_examples * np.dot(X.T, delta2) 
